...
public struct Popup<PopupContent>: ViewModifier where PopupContent: View {
    ...
    private var displayedOffset: CGFloat {
        ...
        case .floater(let verticalPadding):
            if position == .bottom {
                return screenHeight - presenterContentRect.midY - sheetContentRect.height/2 - verticalPadding - 100
            } else {
                return -presenterContentRect.midY + sheetContentRect.height/2 + verticalPadding + 50
            }
        }
    }
